...
async function deployContract(contractDeployer, contractCompiled, initialMessage, account) {
    return contractDeployer
        ...
        .deploy({data: contractCompiled.bytecode, arguments: [initialMessage]})
...
describe ('Inbox Contract tests', () => {
    ...
    beforeEach(async () => {
        ...
        const abi = JSON.parse(contractCompiled.interface);
        ...
        contractDeployer = new web3.eth.Contract(abi);
    })
